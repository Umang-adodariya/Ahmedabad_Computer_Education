                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/dixitbhai.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Dixitkumar Prajapati</h2>
                                <p class="desig">DevOps Engineer & Cybersecurity Training Expert</p>
                            </div>
                        ...
                        <p>Dixitkumar Prajapati brings a powerful combination of DevOps expertise and cybersecurity training experience to the table. With extensive experience in designing, deploying, and securing scalable infrastructures.
                        </p>
                        <div class="about-quality">
                            ...
                            <div class="quality-box">
                                ...
                                <span class="quality-text">8 Years</span>
                            </div>
                        </div>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <p>Dixitkumar's 8 years of teaching experience translate into a dynamic and hands-on learning environment. He promotes clear understanding of complex concepts with a practical approach.</p>
                        <h3 class="title h4 fw-semibold mb-40">Why Choose Dixitkumar as Your Instructor?</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>Dynamic & Hands-On Learning:</b> Learn by doing and gain practical skills.</li>
                                <li class="course-acc-li"><b>Clarity & Practicality:</b> Complex concepts made easy to understand and apply.</li>
                                <li class="course-acc-li"><b>Problem-Solving Mindset:</b> Develop critical thinking skills to tackle real-world challenges.</li>
                                <li class="course-acc-li"><b>Supportive & Approachable:</b> Get personalized guidance in a comfortable learning environment.</li>
                                <li class="course-acc-li"><b>Extensive Training Experience:</b> Benefit from Dixitkumar's 40+ delivered webinars, workshops, and awareness campaigns.</li>
                            </ul>
                        </div>
                        ...
                        <h3 class="title h4 fw-semibold mt-n1">Key Skills & Certifications:</h3>
                      
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>DevOps Expertise:</b> Master of cloud platforms, containerization, and microservices.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Cybersecurity Training:</b> Dedicated to empowering individuals and organizations in cybersecurity best practices.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>M.Tech Qualification:</b> Strong foundation in technology and engineering.</div></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
