                    ...
                    <div class="course-single">
                        <div class="course-single-top">
                            <div class="course-img">
                                <img src="assets/img/courses/corses-main/react-native-1.jpg" alt="Course Image">
                            ...
                            <div class="tab-content" id="productTabContent">
                                <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel"
                                    ...
                                    <div class="course-description">
                                        ...
                                        <p>Which is the one tool that will help you build apps across platforms without
                                            you having to learn new languages or operating systems? The answer is React
                                            Native. This exciting new tool for building native applications lets you
                                            reuse code written in JavaScript across the web and mobile thus making
                                            product development much more streamlined.</p>
                                        <h5 class="h5 mt-40">What Will You Learn?</h5>
                                        <p>Quickly synergize cutting-edge scenarios and professional results.
                                            Assertively deliver cross-media results before client-centric results.
                                            Uniquely initiate intuitive communities through process-centric internal or
                                            "organic" sources. Energistically reinvent distinctive value via parallel
                                            services extensive paradigms cross-unit manufactured products.</p>
                                        <div class="row mt-25">
                                            <div class="col-lg-6">
                                                <div class="checklist mb-4">
                                                    <ul>
                                                        <li>To Create new and innovative native applications for mobile
                                                        </li>
                                                        <li>The Fundamentals of React Native</li>
                                                        <li>To create apps for both IOS and Android</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="checklist">
                                                    <ul>
                                                        <li>To create smaller reusable components from comples
                                                            components</li>
                                                        <li>Creating authentications for apps</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info  ">
                            <div class="th-video">
                                <img src="assets/img/courses/corses-main/react-native-2.jpg" alt="video">
