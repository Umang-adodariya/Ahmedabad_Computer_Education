    ...
    <section class="space">
        <div class="container">
                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/sweta-rao.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Sweta Rao</h2>
                                <p class="desig">CMS & Web Development Expert</p>
                            </div>
                        ...
                        <p>Sweta Rao, experienced IT instructor at ACE IT Training Institute, is passionate about empowering students with the skills to navigate the ever-evolving tech landscape. With a deep understanding of CMS and web development, Sweta makes complex topics accessible and engaging for learners of all levels.</p>
                        <div class="about-quality">
                            <div class="quality-box">
                                <span class="quality-text">Course: 1</span>
                                <span class="quality-text">Students: 120+</span>
                            </div>
                            <div class="quality-box">
                        ...
                        <div class="about-contact-wrap">
                            <div class="about-contact">
                                ...
                                <div class="about-contact-details">
                                    ...
                                    <a href="tel:(+91)93272 87700" class="about-contact-title">(+91)93272 87700</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        <p>With 5 years of experience, Sweta fosters a supportive learning environment that encourages active participation. Her focus on real-world application ensures students gain practical skills for success.</p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>Content Management Systems (CMS):</b> Master popular platforms like WordPress and Shopify.</li>
                                <li class="course-acc-li"><b>Web Development Fundamentals:</b> Learn HTML, CSS, and Webflow to build dynamic websites.</li>
                            </ul>
                        </div>
                        <div class="row gy-4 mb-60">
                            ...
                            <div class="col-md-4">
                                <div class="skill-card">
                                    <h4 class="skill-card-number"><span class="counter-number">99</span>%</h4>
                                    <p class="skill-card-title">Happy Students </p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="skill-card">
                                    <h4 class="skill-card-number"><span class="counter-number">10</span>+</h4>
                                    <p class="skill-card-title">Certificate</p>
                                </div>
                            </div>
                        </div>
                        <h3 class="title h4 fw-semibold mt-n1">Awards, Certifications and Qualifications:</h3>
                      
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><b>Master of Science in Information Technology (M.Sc IT)</b></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Interactive & Student-Centered Learning:</b> Engage, collaborate, and tackle challenges together.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Proven Track Record of Success:</b> Watch past students thrive in top tech companies.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Industry-Leading Expertise & Insights:</b> Gain a competitive edge with the latest trends.</div></li>
                               </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
