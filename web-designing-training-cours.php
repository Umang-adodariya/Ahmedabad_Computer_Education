                    ...
                    <div class="course-single">
                        <div class="course-single-top">
                            <div class="course-img">
                                <img src="assets/img/courses/corses-main/webDesignInner.jpg" alt="Course Image">
                                            ...
                                            <div class="accordion cus-accordion" id="accordionExample">
                                                    ...
                                                    <div class="accordion-body course-acc-body">
                                                        <div class="checklist mb-1">
                                                            <ul class="course-acc-ul">
                                                                <li class="course-acc-li">Introduction to World Wide Web</li>
                                                                <li class="course-acc-li">Protocols of WWW</li>
                                                                <li class="course-acc-li">Hypertext and links</li>
                                                                <li class="course-acc-li">URL and Domain Name System</li>
                                                                <li class="course-acc-li">Internet</li>
                                                                <li class="course-acc-li">Internet Browsers</li>
                                                                <li class="course-acc-li">Web site</li>
                                                                <li class="course-acc-li">Web Page</li>
                                                                <li class="course-acc-li">Home Page</li>
                                                            ...
                                                            <ul class="course-acc-ul">
                                                                <li class="course-acc-li">
                                                                    ...
                                                                    <ul class="mt-2">
                                                                        ...
                                                                        <li class="course-acc-li">HTML Tags</li>
                                                                        <li class="course-acc-li">HTML Anchor Tag</li>
                                                                        <li class="course-acc-li">Images</li>
                                                                        <li class="course-acc-li">HTML List</li>
                                                                        <li class="course-acc-li">HTML Table</li>
                                                                        <li class="course-acc-li">HTML Form</li>
                                                                        <li class="course-acc-li">HTML Events</li>
                                                                        <li class="course-acc-li">Div And Span</li>
                                                                    </ul>
                                                                </li>
                                                                <li class="course-acc-li">
                                                                    CSS
                                                                    <ul class="mt-2">
                                                                        <li class="course-acc-li">CSS Syntax</li>
                                                                        <li class="course-acc-li">CSS Boxes</li>
                                                                        <li class="course-acc-li">CSS Selector</li>
                                                                        <li class="course-acc-li">Font Formatting with CSS</li>
                                                                        <li class="course-acc-li">Applying CSS</li>
                                                                        <li class="course-acc-li">Floating and Positioning</li>
                                                                        <li class="course-acc-li">Page Layout with CSS</li>
                                                                        <li class="course-acc-li">Liquid Page Design</li>
                                                                        <li class="course-acc-li">Fixed Page Design</li>
                                                                        <li class="course-acc-li">Elastic Page Design</li>
                                                                        <li class="course-acc-li">Type of CSS [inline, internal, external]</li>
                                                                        <li class="course-acc-li">Margins and Paddings</li>
                                                        ...
                                                        <div class="checklist mb-1">
                                                            <ul class="course-acc-ul">
                                                                <li class="course-acc-li">
                                                                    HTML 5
                                                                    <ul class="mt-2">
                                                                        <li class="course-acc-li">HTML5 basic tags</li>
                                                                        <li class="course-acc-li">Form tag</li>
                                                                        
                                                                    </ul>
                                                                </li>
                                                                <li class="course-acc-li">CSS 3</li>
                                                                <li class="course-acc-li">Responsive Designing</li>
                                                                <li class="course-acc-li">Basic scripting</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                  ...
                                                  <div id="collapseFour" class="accordion-collapse course-acc-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body course-acc-body">
                                                        <div class="checklist mb-1">
                                                            <ul class="course-acc-ul">
                                                                <li class="course-acc-li">JAVA-SCRIPT Basic</li>
                                                                <li class="course-acc-li">JQUERY Basic</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                  </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                  ...
                                                  <div id="collapseFive" class="accordion-collapse course-acc-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body course-acc-body">
                                                        <div class="checklist mb-1">
                                                            <ul class="course-acc-ul">
                                                                <li class="course-acc-li">How to create a layout in Bootstrap</li>
                                                                <li class="course-acc-li">Basic tags in Bootstrap</li>
                                                                <li class="course-acc-li">Table in Bootstrap</li>
                                                                <li class="course-acc-li">Nav bar in Bootstrap</li>
                                                                <li class="course-acc-li">Form in Bootstrap</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                  </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                  <h2 class="accordion-header" id="headingSix">
                                                    <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                                        TOOLS
                                                    </button>
                                                  </h2>
                                                  <div id="collapseSix" class="accordion-collapse course-acc-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body course-acc-body">
                                                        <div class="checklist mb-1">
                                                            <ul class="course-acc-ul">
                                                                <li class="course-acc-li">Adobe Dreamweaver</li>
                                                                <li class="course-acc-li">Notepad++ </li>
                                                                <li class="course-acc-li">HTML,CSS,CSS3,HTML5,Bootstrap</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                  </div>
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info  ">
                            <div class="th-video">
                                <img src="assets/img/courses/corses-main/webDesignInner.jpg" alt="video">
