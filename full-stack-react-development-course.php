                    ...
                    <div class="course-single">
                        <div class="course-single-top">
                            <div class="course-img">
                                <img src="assets/img/courses/corses-main/course-reactjs.jpg" alt="Course Image">
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-scc-li">What is Namespaced Components?</li>
                                                                    <li class="course-scc-li">What are the JavaScript expressions available in JSX?</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseThree" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-scc-li">Node setup</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseFive" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-scc-li">Lists of Form Components.</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseSix" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-scc-li">Initial Render</li>
                                                                    <li class="course-scc-li">Props Change</li>
                                                                    <li class="course-scc-li">Stage Change</li>
                                                                    <li class="course-scc-li">Component willMount</li>
                                                                    <li class="course-scc-li">Component didMount</li>
                                                                    <li class="course-scc-li">Component Unmount</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseSeven" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-scc-li">Single Page Application Overview.</li>
                                                                    <li class="course-scc-li">How to configure React Router?</li>
                                                                    <li class="course-scc-li">History of Router</li>
                                                                    <li class="course-scc-li">How to Handle Conditional Statement in JSX?</li>
                                                                    <li class="course-scc-li">IIFE in JSX for complex logic overview.</li>
                                                                    <li class="course-scc-li">Flow of states, initialize and update states</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseTen" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">How to load the router library?</li>
                                                                    <li class="course-acc-li">Configure the React Router?</li>
                                                                    <li class="course-acc-li">How to pass and receive parameters?</li>
                                                                    <li class="course-acc-li">Integration of React-Cookie Overview</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseEleven" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Introduction to One Store</li>
                                                                    <li class="course-acc-li">Provider Component</li>
                                                                    <li class="course-acc-li">Actions</li>
                                                                    <li class="course-acc-li">Reducers</li>
                                                                    <li class="course-acc-li">Sagas</li>
                                                                    <li class="course-acc-li">Dispatchers</li>
                                                                    <li class="course-acc-li">View Controllers</li>
                                                                    <li class="course-acc-li">Selector</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingTwelve">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            Module 12 [Unit Testing Overview]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseTwelve" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">What are the necessary Tools required for unit Testing?</li>
                                                                    <li class="course-acc-li">React Unit Testing Overview</li>
                                                                    <li class="course-acc-li">Introduction to JEST</li>
                                                                    <li class="course-acc-li">How to Test React Component</li>
                                                                    <li class="course-acc-li">How to Test React Router?</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="course-instructor">
                                        <div class="course-author-box">
                                            <div class="auhtor-img">
                                                <img src="assets/img/instructor/himanshu-dabhi.png" alt="Author Image">
                                            </div>
                                        ...
                                        <div class="course-author-box">
                                            <div class="auhtor-img">
                                                <img src="assets/img/instructor/uvesh.jpg" alt="Author Image">
                                            </div>
                                            <div class="media-body">
