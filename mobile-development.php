    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-course-detail.png" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title">Mobile Development</h1>
                    ...
                    <div class="course-single">
                        <div class="course-single-top">
                            <div class="course-img">
                                <img src="assets/img/courses/corses-main/mobile-development.jpg" alt="Course Image">
                            ...
                            <h2 class="course-title">Best Mobile Development Course</h2>
                        </div>
                            ...
                            <div class="tab-content" id="productTabContent">
                                <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                    <div class="course-description">
                                        ...
                                        <p>Android is open source and Google releases the code under the Apache License. This open-source code and permissive licensing allows the software to be freely modified and distributed by device manufacturers, wireless carriers and enthusiast developers. Additionally, Android has a large community of developers writing applications (“apps”) that extend the functionality of devices, written primarily in a customized version of the Java programming language.</p>
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Introduction to Java and Android</li>
                                                                    <li class="course-acc-li">Introducing Development Framework</li>
                                                                    <li class="course-acc-li">Dalvik Virtual Machine – DVM</li>
                                                                    <li class="course-acc-li">Developing with Eclipse</li>
                                                                    <li class="course-acc-li">Android Virtual Device and SDK Manager</li>
                                                                    <li class="course-acc-li">Android Architecture and OOPS</li>
                                                                    <li class="course-acc-li">Android Development Tools</li>
                                                                    <li class="course-acc-li">Android Asset Packaging Tools(AAPT)</li>
                                                                    <li class="course-acc-li">Android Debug Bridge</li>
                                                                    <li class="course-acc-li">Types of Android Applications</li>
                                                                    <li class="course-acc-li">Activity Lifecycle</li>
                                                                    <li class="course-acc-li">Activity Classes</li>
                                                                    <li class="course-acc-li">Introduction to Application Manifest</li>
                                                                    <li class="course-acc-li">Installing Android</li>
                                                                    <li class="course-acc-li">Component Lifecycle</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingTwo">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            Module 2 [Android Architecture and OOPS]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseTwo" class="accordion-collapse course-acc-collapse collapse" aria-labelledby="headingTwo"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Building blocks of Android</li>
                                                                    <li class="course-acc-li">Java Classes and Objects</li>
                                                                    <li class="course-acc-li">Class Methods and Instances</li>
                                                                    <li class="course-acc-li">Inheritance and Polymorphism in Java</li>
                                                                    <li class="course-acc-li">Interface and Abstract Class</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingThree">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            Module 3 [Android UI and Component]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseThree" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Android Layouts</li>
                                                                    <li class="course-acc-li">Android UI and Advance Java</li>
                                                                    <li class="course-acc-li">Android GUI Architecture</li>
                                                                    <li class="course-acc-li">Layouts</li>
                                                                    <li class="course-acc-li">Android Widget Toolbox</li>
                                                                    <li class="course-acc-li">Web View</li>
                                                                    <li class="course-acc-li">Grid View</li>
                                                                    <li class="course-acc-li">Understanding Android Menus</li>
                                                                    <li class="course-acc-li">Intents and Processes</li>
                                                                    <li class="course-acc-li">Fragments</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseFour" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">SQLite Database</li>
                                                                    <li class="course-acc-li">Cursors and Content Values</li>
                                                                    <li class="course-acc-li">SQLite Open Helper Adding</li>
                                                                    <li class="course-acc-li">Updating and Deleting Content</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingFive">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            Module 5 [Advance Android Development]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseFive" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Graphics Animation and Multimedia</li>
                                                                    <li class="course-acc-li">Bitmaps</li>
                                                                    <li class="course-acc-li">Introduction to Audio on Android</li>
                                                                    <li class="course-acc-li">Introduction to Video</li>
                                                                    <li class="course-acc-li">Android Persistence</li>
                                                                    <li class="course-acc-li">Android Preferences</li>
                                                                    <li class="course-acc-li">Using File System</li>
                                                                    <li class="course-acc-li">Accessing SD Cards</li>
                                                                    <li class="course-acc-li">Location and Maps</li>
                                                                    <li class="course-acc-li">Using Wake Locks</li>
                                                                    <li class="course-acc-li">Android Text to Speech</li>
                                                                    <li class="course-acc-li">Inter process Communication</li>
                                                                    <li class="course-acc-li">Broadcast receivers</li>
                                                                    <li class="course-acc-li">Using Camera</li>
                                                                    <li class="course-acc-li">Sensor Manager</li>
                                                                    <li class="course-acc-li">Bluetooth</li>
                                                                    <li class="course-acc-li">Network</li>
                                                                    <li class="course-acc-li">Wi-Fi</li>
                                                                    <li class="course-acc-li">AIDL and IPC</li>
                                                                    <li class="course-acc-li">XML Parsing</li>
                                                                    <li class="course-acc-li">Dom Parsing</li>
                                                                    <li class="course-acc-li">SAX Parsing</li>
                                                                    <li class="course-acc-li">Pull Parsing</li>
                                                                    <li class="course-acc-li">JSON Parsing</li>
                                                                    <li class="course-acc-li">GEO Coder API</li>
                                                                    <li class="course-acc-li">SQLite Databases</li>
                                                                    <li class="course-acc-li">Services and Content Providers</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingSix">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            Module 6 [Industry Oriented Projects]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseSix" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Project Scope</li>
                                                                    <li class="course-acc-li">Database Dictionary</li>
                                                                    <li class="course-acc-li">Flow Chart</li>
                                                                    <li class="course-acc-li">High Level Requirements</li>
                                                                    <li class="course-acc-li">Using Bluetooth and NFC in Android device</li>
                                                                    <li class="course-acc-li">Localization in Android</li>
                                                                    <li class="course-acc-li">Configuration changes</li>
                                                                    <li class="course-acc-li">Security and permissions</li>
                                                                    <li class="course-acc-li">Web Services Integration</li>
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info  ">
                            <div class="th-video">
                                <img src="assets/img/courses/corses-main/mobile-development-2.jpg" alt="video">
