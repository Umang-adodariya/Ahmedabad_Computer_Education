        ...
        <div class="container">
            <div class="team-details-about-info">
                <div class="row gx-40">
                    ...
                    <img src="assets/img/loaderIc.png" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Ankit Patel</h2>
                                <p class="desig">Blockchain Developer (Full-Stack Expert )</p>
                            </div>
                        ...
                        <p>Ankit Patel is a skilled blockchain and full-stack developer with a passion for building innovative solutions. With over 3 years of experience, Ankit has a proven track record of delivering cutting-edge projects, from smart contracts to decentralized applications.</p>
                        <div class="about-quality">
                            <div class="quality-box">
                                <span class="quality-text">Course: 1</span>
                                <span class="quality-text">Students: 130+</span>
                            </div>
                            <div class="quality-box">
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        <p>Ankit's teaching style is focused on hands-on learning and practical application. With 3+ years of experience in mentoring and training, he is adept at breaking down complex concepts into easy-to-understand explanations.</p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><div><b>Blockchain Development:</b> Ethereum, Binance Smart Chain, Solana, Ton, Hyperledger Fabric</div></li>
                                <li class="course-acc-li"><div><b>Full-Stack Development:</b> Python, React.js, Node.js</div></li>
                                <li class="course-acc-li"><div><b>DeFi Protocols:</b> Decentralized finance platforms</div></li>
                                <li class="course-acc-li"><div><b>Wallet Development:</b> Custodial and non-custodial wallets</div></li>
                                <li class="course-acc-li"><div><b>Backend Development:</b> Node.js, Flask, Django</div></li>
                            </ul>
                        </div>
                        ...
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>Certified Blockchain Developer</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>Advanced Full-Stack Development Certification</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>Bachelor's Degree in Electronic and Communication</div></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
