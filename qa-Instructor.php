    ...
    <section class="space">
        <div class="container">
                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/jimmy.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Jimmy Chotaliya</h2>
                                <p class="desig">Quality Assurance Expert</p>
                            </div>
                        ...
                        <p>Jimmy Chotaliya is a seasoned QA professional with a strong foundation in manual and automation testing. His expertise in process optimization and team leadership ensures the delivery of high-quality, reliable products.</p>
                        <div class="about-quality">
                            <div class="quality-box">
                                <span class="quality-text">Course: 1</span>
                                <span class="quality-text">Students: 15+</span>
                            </div>
                            <div class="quality-box">
                            ...
                            <div class="quality-box">
                                ...
                                <span class="quality-text">2.5 Years</span>
                            </div>
                        </div>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        <p>With 2.5 years of teaching experience, Jimmy is passionate about sharing his knowledge and empowering students to succeed in the QA field.</p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>Manual Testing:</b> Rigorous testing methodologies to identify and resolve defects.</li>
                                <li class="course-acc-li"><b>Testing Methodologies:</b> Understanding and applying effective testing strategies.</li>
                                <li class="course-acc-li"><b>Automation Testing with Selenium Java:</b> Automating test cases for efficient and reliable testing.</li>
                            </ul>
                        </div>
                        ...
                        <div class="checklist style5 mt-30">
                            <ul>
                                ...
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i>Focus on Practical Application: Real-world examples and hands-on experience.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
