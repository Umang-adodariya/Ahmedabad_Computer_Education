    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-course-detail.png" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title">Graphic Design Training & Certification Course</h1>
                ...
                <div class="col-xxl-9 col-lg-8">
                    <div class="course-single">
                        <div class="course-single-top">
                            ...
                            <h2 class="course-title">Best Graphic Designing Course</h2>
                        </div>
                            ...
                            <div class="tab-content" id="productTabContent">
                                <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                    <div class="course-description">
                                        ...
                                        <p>We offer graphic design course Ahmedabad to inculcate aesthetic skills in learners and develop visual communication between clients and the company. All the significant points of graphic designing like photoshop, brochure designing, logo designing, creative banner making, typography, motion graphics, etc. are included in this course. On course completion, you will be professional with tools and information to create designs.</p>
                                        ...
                                        <div class="row mt-25">
                                            <div class="col-lg-6">
                                                <div class="checklist mb-4">
                                                    <ul>
                                                        <li>Introduction to illustrator and its workspace</li>
                                                        <li>CorelDRAW</li>
                                                        <li>Photoshop</li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="checklist">
                                                    <ul>
                                                        <li>Video Editing</li>
                                                        <li>Web Application and image integration</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <h5 class="h5 mt-40">Graphic Design Training And Certification Course At Ahmedabad Computer Education</h5>
                                        <p>With Ahmedabad Computer Education’s Graphic Design course, you will learn how to create stunning visual communications and the basics of Graphic Design. You will learn about design elements, typography, color theory, and composition in a graphics design course. As well as practicing your skills, you can also create your designs. You can improve your skills by taking a graphics design course, no matter if you are looking to be a professional graphic designer or just want to create better visuals for your blog or website.</p>
                                        <div class="checklist mb-4 mt-4">
                                            <ul>
                                                <li><strong>Land Your Dream Job:</strong> Get placement assistance and career guidance to kickstart your success.</li>
                                                <li><strong>Learn at Your Pace:</strong> Choose from flexible batch timings that fit your busy schedule.</li>
                                                <li><strong>Personalized Support:</strong> Our experts are available to provide meticulous guidance.</li>
                                                <li><strong>Expert Instructors: </strong>Gain knowledge from highly qualified and accredited professionals.</li>
                                                <li><strong>Affordable Education: </strong>Get top-notch training without breaking the bank.</li>
                                                <li><strong>Hands-on Learning: </strong>Apply your skills through real-world projects and case studies.</li>
                                                <li><strong>One-on-One Focus: </strong>Benefit from personalized training sessions tailored to your needs.</li>
                                                <li><strong>Industry-Recognized Certification:</strong> Earn a valuable certification upon successful course completion.</li>
                                            </ul>
                                            <p class="mt-4">Graphic designers create visual concepts, by hand or using computer software, to communicate ideas that inspire, inform, or captivate consumers. They develop the overall layout and production design for advertisements, brochures, magazines, and corporate reports.</p>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <ul class="course-acc-ul">
                                                                ...
                                                                <li class="course-acc-li mt-3">
                                                                    ...
                                                                    <ul class="mt-3">
                                                                        ...
                                                                        <li class="course-acc-li">Image masking</li>
                                                                        <li class="course-acc-li">Wallpaper design</li>
                                                                        <li class="course-acc-li">GIF animation</li>
                                                                        <li class="course-acc-li">Web layout design</li>
                                                                    </ul>
                                                                </li>
                                                                <li class="course-acc-li mt-3">
                                                                    In Design
                                                                    <ul class="mt-3">
                                                                        <li class="course-acc-li">How to open, create & save lnDesign file</li>
                                                                        <li class="course-acc-li">Basic introduction about lnDesign</li>
                                                                        <li class="course-acc-li">Introduction about all lnDesign tools</li>
                                                                        <li class="course-acc-li">Visiting card</li>
                                                                        <li class="course-acc-li">Greeting card</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                  <h2 class="accordion-header" id="headingThree">
                                                    <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        Module 3 [Video Editing Software]
                                                    </button>
                                                  </h2>
                                                  <div id="collapseThree" class="accordion-collapse course-acc-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body course-acc-body">
                                                        <div class="checklist mb-1">
                                                            <ul class="course-acc-ul">
                                                                <li class="course-acc-li">How to open, create & save Camtasia Studio</li>
                                                                <li class="course-acc-li">File</li>
                                                                <li class="course-acc-li">Basic introduct on about Camtasia Studio</li>
                                                                <li class="course-acc-li">Video and Sound edit ng</li>
                                                                <li class="course-acc-li">Video and Sound effffect</li>
                                                                <li class="course-acc-li">Convert to video fifile</li>
                                                                <li class="course-acc-li mt-3">
                                                                    TOOLS
                                                                    <ul class="mt-3">
                                                                        <li class="course-acc-li">Adobe Illustrator</li>
                                                                        <li class="course-acc-li">Adobe Photoshop</li>
                                                                        <li class="course-acc-li">CorelDRAW</li>
                                                                        <li class="course-acc-li">Adobe In Designing</li>
                                                                        <li class="course-acc-li">Adobe In Flash</li>
                                                                        <li class="course-acc-li">Camtasia Studio</li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                        </div>
