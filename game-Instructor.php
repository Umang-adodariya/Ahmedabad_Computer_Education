    ...
    <section class="space">
        <div class="container">
                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/rajdeep.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Rajdeep Rathod</h2>
                                <p class="desig">Unity Game Development Expert</p>
                            </div>
                        ...
                        <p>Rajdeep Rathod is a seasoned Unity game developer with a passion for creating immersive and engaging gaming experiences. With a strong foundation in 2D and 3D game development, Rajdeep is skilled in crafting captivating gameplay mechanics, AI, and stunning visuals.</p>
                        <div class="about-quality">
                            <div class="quality-box">
                                <span class="quality-text">Course: 1</span>
                                <span class="quality-text">Students: 85+</span>
                            </div>
                            <div class="quality-box">
                            ...
                            <div class="quality-box">
                                ...
                                <span class="quality-text">3 Years</span>
                            </div>
                        </div>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        <p> With 3 years of teaching experience, Rajdeep is adept at breaking down complex concepts into easy-to-understand explanations. He is dedicated to fostering a collaborative learning environment where students can experiment, learn, and grow.
                            </p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>2D & 3D Game Development:</b> Build captivating games for various platforms.</li>
                                <li class="course-acc-li"><b>VR Game Development:</b> Create immersive virtual reality experiences.</li>
                                <li class="course-acc-li"><b>Multiplayer Game Development:</b> Design and implement multiplayer features for online gaming.</li>
                                <li class="course-acc-li"><b>Gameplay Mechanics & Scripting:</b> Write clean and efficient code to bring games to life.</li>
                                <li class="course-acc-li"><b>UI/UX Design:</b> Create intuitive and visually appealing user interfaces.</li>
                            </ul>
                        </div>
                        ...
                        <h3 class="title h4 fw-semibold mt-n1">Qualifications & Expertise:</h3>
                      
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i>Diploma in Information Technology</li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Real-World Experience:</b> Learn from a seasoned game developer with industry experience.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Engaging Teaching Style:</b> Interactive lessons, practical exercises, and project-based learn</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Personalized Guidance:</b> Receive tailored support and feedback to help you succeed.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Problem-Solving Mindset:</b> Develop critical thinking and problem-solving skills.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Passion for Teaching:</b> Empower students to reach their full potential.</div></li>
                               </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
