                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/karan.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Karan Parmar</h2>
                                <p class="desig">Flutter Development Expert </p>
                            </div>
                        ...
                        <p>Karan Parmar is a seasoned Flutter developer and experienced IT instructor at ACE. With a passion for teaching and a deep understanding of mobile app development, Karan is committed to empowering students with the skills to succeed in the fast-paced tech industry.</p>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>Flutter App Development:</b> Build beautiful and performant cross-platform apps.</li>
                                <li class="course-acc-li"><b>Dart Programming:</b> Master the language behind Flutter development.</li>
                                <li class="course-acc-li"><b>UI/UX Design:</b> Create stunning user interfaces for your apps.</li>
                            </ul>
                        </div>
                        ...
                        <h3 class="title h4 fw-semibold mt-n1">Certifications and Expertise:</h3>
                      
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Bachelor of Computer Applications (BCA)
                                </b></div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Master of Computer Applications (MCA)</b></div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Real-World Project-Based Learning:</b> Gain practical experience through hands-on projects.</div>
                                </li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Clear and Engaging Teaching Style:</b> Complex concepts made easy to understand.</div>
                                </li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Personalized Learning:</b> Tailored approach to meet individual needs and goals.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Innovative Teaching Methods:</b> Foster creativity and problem-solving skills.</div>
                                </li>
                               </ul>
                        </div>
                    </div>
