                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/priya.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Priya Jaiswal</h2>
                                <p class="desig">Business Analyst</p>
                            </div>
                        ...
                        <p>A passionate professional with a robust background in business analysis and software development. With a keen eye for detail and a strong commitment to driving impactful results, I bridge the gap between business needs and technology solutions. My journey as a Business Analyst and SDE has been fueled by problem-solving, collaboration, and the pursuit of innovation.</p>
                        <div class="about-quality">
                            <div class="quality-box">
                                <span class="quality-text">Course: 1</span>
                                <span class="quality-text">Students: 25+</span>
                            </div>
                            <div class="quality-box">
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <p>Experienced mentoring and teaching aspiring professionals in the fields of business analysis, programming, and data analytics.</p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>Data Analysis & Visualization:</b> Expertise in analyzing complex datasets and presenting actionable insights using tools like MockFlow,Matplotlib,Power BI, and Excel.
                                </li>
                                <li class="course-acc-li"><b>Agile Project Management:</b> Skilled in facilitating agile workflows, sprint planning, and stakeholder communication to deliver high-quality software.</li>
                                <li class="course-acc-li"><b>Software Development & Automation:</b> Proficient in developing efficient, scalable applications using programming languages like JavaScript,R, Java, and MySQL.</li>
                            </ul>
                        </div>
                        ...
                        <h3 class="title h4 fw-semibold mt-n1">Certifications and Qualifications:</h3>
                        ...
                        <div class="checklist style5 mt-30">
                            <ul>
                                ...
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Master of Science in Information Technology </b></div></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
