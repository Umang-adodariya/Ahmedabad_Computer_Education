        ...
        <div class="container">
            <div class="row gy-4 masonary-active">
                <div class="col-md-6 col-xxl-auto filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/327/01.jpg" alt="gallery image">
                            <a href="assets/img/gallery/327/01.jpg" class="gallery-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xxl-auto filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/02.jpg" alt="gallery image">
                            <a href="assets/img/gallery/02.jpg" class="gallery-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xxl-auto filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/327/03.jpg" alt="gallery image">
                            <a href="assets/img/gallery/327/03.jpg" class="gallery-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xxl-auto filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/327/05.jpg" alt="gallery image">
                            <a href="assets/img/gallery/327/05.jpg" class="gallery-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xxl-auto filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/03.jpg" alt="gallery image">
                            <a href="assets/img/gallery/03.jpg" class="gallery-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xxl-auto filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/04.jpg" alt="gallery image">
                            <a href="assets/img/gallery/04.jpg" class="gallery-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xxl-auto filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/05.jpg" alt="gallery image">
                            <a href="assets/img/gallery/05.jpg" class="gallery-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xxl-auto filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/327/10.jpg" alt="gallery image">
                            <a href="assets/img/gallery/327/10.jpg" class="gallery-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>
