                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/ram.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Ram Gondaliya</h2>
                                <p class="desig">UI/UX Designer & Graphic Design Expert</p>
                            </div>
                        ...
                        <p>With 6 years of experience in crafting stunning and user-centric designs, Ram Gondaliya is a master of his craft. From websites to mobile apps, Ram has a proven track record of creating visually appealing and functional designs that resonate with users.</p>
                        <div class="about-quality">
                            <div class="quality-box">
                                <span class="quality-text">Course: 2</span>
                            ...
                            <div class="quality-box">
                                ...
                                <span class="quality-text">6 Years</span>
                            </div>
                        </div>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <p>Ram's 6 years of teaching experience ensures a comprehensive and practical learning experience. He is passionate about sharing his knowledge and empowering students to become skilled designers.
                        </p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>CorelDRAW, Adobe Photoshop, and Adobe Illustrator:</b> Master the industry-standard tools for graphic design.</li>
                                <li class="course-acc-li"><b>Adobe XD and Figma:</b> Learn the latest design tools for creating exceptional user experiences.
                                </li>
                        ...
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Bachelor of Computer Applications (BCA)</b></div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Interactive and Hands-On Approach:</b> Learn by doing with real-world projects.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Clear and Concise Explanations:</b> Complex concepts made easy to understand.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Personalized Guidance:</b> Tailored support to meet your individual needs.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Problem-Solving Skills:</b> Develop critical thinking and creative problem-solving abilities.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Inspiring and Empowering:</b> Gain the confidence to create exceptional designs.</div>
                                </li>
                            </ul>
                        </div>
                    </div>
