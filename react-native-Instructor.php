    ...
    <section class="space">
        <div class="container">
                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/yash.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Yash Nandha</h2>
                                <p class="desig">React Native Developer</p>
                            </div>
                        ...
                        <p>Yash Nandha is a passionate React Native developer with a knack for innovation. With a strong foundation in JavaScript and TypeScript, Yash specializes in crafting exceptional mobile applications for both iOS and Android platforms.</p>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        <p>With 6 years of teaching experience, Yash is skilled at breaking down complex concepts into easy-to-understand explanations. He is dedicated to fostering a collaborative learning environment where students can thrive.</p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>React Native:</b> Build cross-platform mobile apps efficiently.</li>
                                <li class="course-acc-li"><b>JavaScript & TypeScript:</b> Master the core technologies of modern web development.</li>
                                <li class="course-acc-li"><b>Photoshop:</b> Design visually appealing graphics and user interfaces.</li>
                                <li class="course-acc-li"><b>Video Editing & Content Creation:</b> Communicate ideas effectively through engaging visuals.</li>
                            </ul>
                        </div>
                        ...
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><b>React Native Certification</b></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><b>Born on Instagram Certification</b></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><b>Bachelor of Computer Engineering</b></li>
                               </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
