                ...
                <div class="col-xxl-9 col-lg-8">
                    <div class="course-single">
                        <div class="course-single-top">
                            ...
                            <h2 class="course-title">Mern Stack Training Course</h2>
                        </div>
                            ...
                            <div class="tab-content" id="productTabContent">
                                <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                    <div class="course-description">
                                        ...
                                        <p>Unlock the potential of MERN (MongoDB, Express.js, React, Node.js) Stack to develop powerful web applications. From front-end design using HTML, CSS, and React to back-end development with Node.js and MongoDB, master the full-stack development process. Gain practical experience through hands-on projects and real-world scenarios.</p>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingThree">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            MODULE 3 [ File System Operations and Streams ]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseThree" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">File system operations in Node.js</li>
                                                                    <li class="course-acc-li">Reading and writing ﬁles</li>
                                                                    <li class="course-acc-li">Working with directories</li>
                                                                    <li class="course-acc-li">Introduction to streams for eﬃcient I/O operations</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseFour" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Introduction to Express.js Framework</li>
                                                                    <li class="course-acc-li">Creating routes and handling HTTP methods</li>
                                                                    <li class="course-acc-li">Middleware and its role in Express</li>
                                                                    <li class="course-acc-li">Serving static ﬁles and handling POST Requests</li>
                                                                    <li class="course-acc-li">Designing RESTful APIs with Express</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseFive" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Introduction to databases and their types</li>
                                                                    <li class="course-acc-li">Relational databases and SQL basics</li>
                                                                    <li class="course-acc-li">Connecting MySQL with Node.js</li>
                                                                    <li class="course-acc-li">Performing CRUD operations</li>
                                                                    <li class="course-acc-li">Introduction to NoSQL databases and MongoDB</li>
                                                                    <li class="course-acc-li">Setting up MongoDB with Node.js</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseSix" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Introduction to authentication and authorization</li>
                                                                    <li class="course-acc-li">Implementing user authentication with JWT</li>
                                                                    <li class="course-acc-li">User registration, login, and session management</li>
                                                                    <li class="course-acc-li">Security best practices: password hashing and salting</li>
                                                                    <li class="course-acc-li">MongoDB Setting up MongoDB with Node.js</li>
                                                                    <li class="course-acc-li">CRUD operations with Mongoose</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-acc-li">
                                                                        ...
                                                                        <ul class="mt-3">
                                                                            ...
                                                                            <li class="course-acc-li">Handling errors and debugging Node.js application</li>
                                                                            <li class="course-acc-li">Implementing security best practices in Node.js</li>
                                                                        </ul>
                                                                    </li>
                                                                    <li class="course-acc-li">Assignment: Hosting Website using Node.js</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-acc-li">Building CRUD operations with Express.js</li>
                                                                ...
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-acc-li">
                                                                        ...
                                                                        <ul class="mt-3">
                                                                            ...
                                                                            <li class="course-acc-li">Best practices for securing MongoDB application</li>
                                                                            <li class="course-acc-li">Implementing data migrations and backups in MongoDB</li>
                                                                        </ul>
                                                                    </li>
                                                                    <li class="course-acc-li">Assignment: Creating ERD & DB for ECommerce Website</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseEleven" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Advanced RESTful API concept</li>
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info  ">
                            <div class="th-video">
                                <img src="assets/img/courses/corses-main/mern-stack-2.jpg" alt="video">
