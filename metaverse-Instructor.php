    ...
    <section class="space">
        <div class="container">
                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/tejas.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Tejas Acharya</h2>
                                <p class="desig">Metaverse & 3D Design Expert</p>
                            </div>
                        ...
                        <p>Tejas Acharya, a seasoned metaverse expert, is passionate about guiding individuals through the exciting realm of virtual reality, augmented reality, and 3D design. With a deep understanding of these technologies, Tejas has honed his skills in creating immersive digital experiences.</p>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        <p>With 4+ years of teaching experience, Tejas has a proven track record of delivering exceptional training programs. He is skilled at breaking down complex concepts into easy-to-understand terms and providing hands-on, project-based learning opportunities.</p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><b>Metaverse Design and Architecture:</b> Design and develop virtual worlds that are both visually stunning and functionally efficient.</li>
                                <li class="course-acc-li"><b>3D Modeling and Animation:</b> Bring your creative visions to life with stunning 3D models and animations.</li>
                                <li class="course-acc-li"><b>User Experience (UX) Design:</b> Craft intuitive and engaging user experiences within virtual environments.</li>
                                <li class="course-acc-li"><b>Virtual Reality (VR) and Augmented Reality (AR) Development:</b> Develop immersive VR and AR applications for various platforms.</li>
                            </ul>
                        </div>
                        ...
                        <h3 class="title h4 fw-semibold mt-n1">Why Choose Tejas Acharya as Your Instructor?</h3>
                      
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Industry Expertise:</b> Stay up-to-date with the latest trends and technologies in the metaverse.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Engaging Teaching Style:</b> Interactive lessons, real-world examples, and practical exercises.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Personalized Guidance:</b> Receive tailored support and feedback to help you achieve your goals.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Strong Community Network:</b> Connect with other metaverse enthusiasts and industry professionals.</div></li>
                               </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
