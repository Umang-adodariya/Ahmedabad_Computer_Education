                    ...
                    <div class="course-single">
                        <div class="course-single-top">
                            <div class="course-img">
                                <img src="assets/img/courses/corses-main/course-php.jpg" alt="Course Image">
                            ...
                            <h2 class="course-title">Best PHP Training Institute</h2>
                        </div>
                            ...
                            <div class="tab-content" id="productTabContent">
                                <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                    <div class="course-description">
                                        ...
                                        <p>The PHP live project training course at Ahmedabad Computer Education covers all spectrums of PHP technology from the beginner level to the advanced level. The features and tools of emerging technologies are all wrapped in this course. Moreover, the course will be based on realistic examples and practical implementation. It will eventually help students with skills enhancement. We have in-house experts with extensive capability to deliver concrete enforcement and develop according to the requirement of the concept. By enrolling in our institute, get a hold of the best instructor in town who has conquered PHP technology from every aspect.</p>
                                        <h5 class="h5">PHP Training Course Introduction What is PHP?</h5>
                                        <p>Scripting languages and interpreters written in PHP are server-side scripting languages and interpreters. Developers can use this API to construct logic and handle data returned from web browsers. PHP scripts embedded in HTML documents are served by this web server. The interpreter converts the script and achieves the results defined in the script by integrating the mode of a module into the webserver. As a result of its popularity, web applications are developed using the language in large numbers.</p>
                                        <h5 class="h5">Why Choose PHP Course in Ahmedabad?</h5>
                                        <p>Having a hands-on PHP training course will help you gain a better understanding of this dynamic framework’s advanced features and functionality. By working with a tutor one-on-one, you will be able to learn the framework and code faster. Learning about relevant industrial practices and making dynamic applications with expert tutors is possible. Personalized training not only resolves your doubts but also provides excellent mentorship to ensure your success.</p>
                                        <h5 class="h5">PHP Training And Certification Course At Ahmedabad Computer Education</h5>
                                        <p>With a job placement program and hands-on PHP training course, Ahmedabad Computer Education is one of the leading PHP training institutes in Ahmedabad. Starting with the fundamentals and progressing to advanced concepts, our PHP developer course follows a gradual learning process. <a href="contact.html" target="_blank" rel="noopener">Join us today!</a></p>
                                        <div class="checklist dis-ul mt-30 mb-40">
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse course-acc-collapse collapse show"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Web Layout</li>
                                                                    <li class="course-acc-li">Introduction</li>
                                                                    <li class="course-acc-li">HTML Elements</li>
                                                                    <li class="course-acc-li">HTML5 Elements</li>
                                                                    <li class="course-acc-li">HTML Tags, Images</li>
                                                                    <li class="course-acc-li">CSS3</li>
                                                                    <li class="course-acc-li">Border</li>
                                                                    <li class="course-acc-li">Box-shadow , Text-shadow</li>
                                                                    <li class="course-acc-li">Multiple Background Images</li>
                                                                    <li class="course-acc-li">HTMLAnchor Tag</li>
                                                                    <li class="course-acc-li">HTML List</li>
                                                                    <li class="course-acc-li">HTML Table</li>
                                                                    <li class="course-acc-li">HTML Form,Div and Span</li>   
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseTwo" class="accordion-collapse course-acc-collapse collapse" aria-labelledby="headingTwo"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">CSS Selector</li>
                                                                    <li class="course-acc-li">Applying CSS
                                                                        <ul class="mt-3">
                                                                            <li class="course-acc-li">lternal</li>
                                                                            <li class="course-acc-li">External</li>
                                                                            <li class="course-acc-li">lnline</li>
                                                                        </ul>
                                                                        <li class="course-acc-li">Margins and Padding</li>
                                                                        <li class="course-acc-li">CSS Background</li>
                                                                        <li class="course-acc-li">CSS Classes and ID</li>
                                                                        <li class="course-acc-li">CSS Pseudo-Classes</li>
                                                                        <li class="course-acc-li">Web Layout</li>
                                                                        <li class="course-acc-li">CSS3
                                                                            <ul class="mt-3">
                                                                                <li class="course-acc-li">Border</li>
                                                                                <li class="course-acc-li">Box-Shadow,Text-Shadow</li>
                                                                                <li class="course-acc-li">Multiple Background Images</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseThree" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Introduction to PHP</li>
                                                                    <li class="course-acc-li">PHP Syntax</li>
                                                                    <li class="course-acc-li">Variables in PHP</li>
                                                                    <li class="course-acc-li">Super Global Variables</li>
                                                                    <li class="course-acc-li">Expresions PHP Operators</li>
                                                                    <li class="course-acc-li">Conditions, Loops</li>
                                                                    <li class="course-acc-li">Is PHP Function</li>
                                                                    <li class="course-acc-li">PHP Functions</li>
                                                                    <li class="course-acc-li">PHP Arrays & Array Functions</li>
                                                                    <li class="course-acc-li">String Functions</li>
                                                                    <li class="course-acc-li">Date And Time Functions</li>
                                                                    <li class="course-acc-li">PHP Include File</li>
                                                                    <li class="course-acc-li">HTTP Protocol</li>
                                                                    <li class="course-acc-li">Header Functions</li>  
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseFour" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">DBMS & RDBMS</li>
                                                                    <li class="course-acc-li">PHP & MySQL</li>
                                                                    <li class="course-acc-li">MySQL Data Types</li>
                                                                    <li class="course-acc-li">Connection To MySQL Database</li>
                                                                    <li class="course-acc-li">Creating Database And Tables In MySQL</li>
                                                                    <li class="course-acc-li">File Uploading In PHP</li>
                                                                    <li class="course-acc-li">PHP MySQL</li>
                                                                    <li class="course-acc-li">Insert Into PHP MySQL Select</li>
                                                                    <li class="course-acc-li">PHP MySQL Where Clause</li>
                                                                    <li class="course-acc-li">PHP MySQL Update PHP</li>
                                                                    <li class="course-acc-li">PHP MySQL Delete</li>
                                                                    <li class="course-acc-li">PHP MySQL Order By Keyword</li>
                                                                    <li class="course-acc-li">Differences Between Group By And Order By</li>
                                                                    <li class="course-acc-li">SQL Join</li>
                                                                    <li class="course-acc-li">SQL Injection</li>
                                                                    <li class="course-acc-li">SQL Aggregate Functions</li>
                                                                    <li class="course-acc-li">PHP Session And Cookie</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseFive" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">OOPS Concept</li>
                                                                    <li class="course-acc-li">PHP MVC Architecture</li>
                                                                    <li class="course-acc-li">File Handling</li>
                                                                    <li class="course-acc-li">Handling Emails</li>
                                                                    <li class="course-acc-li">Javascript</li>
                                                                    <li class="course-acc-li">JQuery</li>
                                                                    <li class="course-acc-li">XML</li>
                                                                    <li class="course-acc-li">Ajax With Javascript</li>
                                                                    <li class="course-acc-li">Ajax With JQuery</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingSix">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            Module 6 [Application To Industrial Projects]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseSix" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">Integration With Web Services</li>
                                                                    <li class="course-acc-li">Embedding PHP Code Into HTML Pages</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
