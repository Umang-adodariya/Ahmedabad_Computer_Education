    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-course-detail.png" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title">SEO Training & Certification Course</h1>
                    ...
                    <div class="course-single">
                        <div class="course-single-top">
                            <div class="course-img">
                                <img src="assets/img/courses/corses-main/course-seo.jpg" alt="Course Image">
                            ...
                            <h2 class="course-title">SEO Certification Course</h2>
                        </div>
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse course-acc-collapse collapse show"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                ...
                                                                <li class="course-scc-li">How Search Engine Works</li>
                                                                <li class="course-scc-li">Browser</li>
                                                                <li class="course-scc-li">AutoFill Tool</li>
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-scc-li">Search Engine Crawler</li>
                                                                    <li class="course-scc-li">Domain and Web Hosting</li>
                                                                    <li class="course-scc-li">White hat Seo</li>
                                                                    <li class="course-scc-li">Google algorithm Updates</li>
                                                                    <li class="course-scc-li">Types of Website</li>
                                                                    <li class="course-scc-li">Types of Information</li>
                                                                    <li class="course-scc-li">Spider View</li>
                                                                    <li class="course-scc-li">Copyscape</li>
                                                                    <li class="course-scc-li">PingWebsite</li>
                                                                    <li class="course-scc-li">Importance of domain age</li>
                                                                    <li class="course-scc-li">Selection of keyword or keyword analysis</li>
                                                                    <li class="course-scc-li">Title optimisation</li>
                                                                    <li class="course-scc-li">Meta tag optimization</li>
                                                                    <li class="course-scc-li">SEO friendly design</li>
                                                                    <li class="course-scc-li">Content optimization</li>
                                                                    <li class="course-scc-li">Image Optimization</li>
                                                                    <li class="course-scc-li">Introduction about link building</li>
                                                                    <li class="course-scc-li">Introduction Robots.txt</li>
                                                                    <li class="course-scc-li">Introduction Site map</li>
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-scc-li">Competitors Website Analysis</li>
                                                                    <li class="course-scc-li">How to Choose Best Keywords</li>
                                                                    <li class="course-scc-li">Tools available for Keyword Research</li>
                                                                    <li class="course-scc-li">Business to business Keyword</li>
                                                                    <li class="course-scc-li">Content Research</li>
                                                                    <li class="course-scc-li">Content Guidelines</li>
                                                                    <li class="course-scc-li">Content Optimization</li>
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-scc-li">Htaccess File</li>
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-scc-li">Headings</li>
                                                                    <li class="course-scc-li">Word Tracker</li>
                                                                    <li class="course-scc-li">H1, H2, H3 Tags</li>
                                                                    <li class="course-scc-li">Anchor Text optimization</li>
                                                                    <li class="course-scc-li">HTML/W3C Validation</li>
                                                                    <li class="course-scc-li">Content Optimization</li>
                                                                    <li class="course-scc-li">HTML Code Optimization</li>
                                                                    <li class="course-scc-li">Bold Text</li>
                                                                    <li class="course-scc-li">Domain Names & Suggestions</li>
                                                                    <li class="course-scc-li">Canonical Tag</li>
                                                                    <li class="course-scc-li">Meta Tags</li>
                                                                    <li class="course-scc-li">Internal Link Building</li>
                                                                    <li class="course-scc-li">The Sitemap</li>
                                                                    <li class="course-scc-li">Server and Hosting Check</li>
                                                                    <li class="course-scc-li">Robots Meta Tag</li>
                                                                    <li class="course-scc-li">301 Redirects</li>
                                                                    <li class="course-scc-li">404 Error</li>
                                                                    <li class="course-scc-li">Duplicate content</li>
                                                                    <li class="course-scc-li">Text</li>
                                                                    <li class="course-scc-li">Image</li>
                                                                    <li class="course-scc-li">Video</li>
                                                                    <li class="course-scc-li">Html</li>
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    ...
                                                                    <li class="course-scc-li">Directory Submission</li>
                                                                    <li class="course-scc-li">Practice of directory submission</li>
                                                                    <li class="course-scc-li">Knowledge about Social bookmarking</li>
                                                                    <li class="course-scc-li">Social bookmarking submission</li>
                                                                    <li class="course-scc-li">Report Verification</li>
                                                                    <li class="course-scc-li">Practice of Social bookmarking</li>
                                                                    <li class="course-scc-li">Practice with Auto fill tool</li>
                                                                    <li class="course-scc-li">Knowledge about classifieds and article writing</li>
                                                                    <li class="course-scc-li">Finding free classifieds</li>
                                                                    <li class="course-scc-li">Classifieds Posting</li>
                                                                    <li class="course-scc-li">Introduction to article submission</li>
                                                                    <li class="course-scc-li">Article writing</li>
                                                                    <li class="course-scc-li">Article Submission</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseSeven" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                <li class="course-scc-li">Knowledge about ( SMO Social Media Optimization)</li>
                                                                <li class="course-scc-li">Account creation for SMO</li>
                                                                <li class="course-scc-li">Promotion by SMO (Image)</li>
                                                                <li class="course-scc-li">Promotion by SMO (Video)</li>
                                                                <li class="course-scc-li">Online Video- content is king</li>
                                                                <li class="course-scc-li">Social sharing, comments and reviews</li>
                                                                <li class="course-scc-li">Promoting YouTube Videos</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="course-instructor">
                                        <div class="course-author-box">
                                            <div class="auhtor-img">
                                                <img src="assets/img/instructor/jay-malvi.jpg" alt="Author Image">
                                            </div>
