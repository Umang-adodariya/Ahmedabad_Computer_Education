    ...
    <section class="space">
        <div class="container">
                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/nikita-karanpuria.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Nikita Karanpuria</h2>
                                <p class="desig">Full Stack Expert (Blockchain Expertise)</p>
                            </div>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        <p>With 4+ years of teaching experience, Nikita is skilled at breaking down complex technical concepts into easy-to-understand explanations. She is committed to fostering a collaborative learning environment where students can experiment, learn, and grow.
                        </p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><div><b>Frontend Development:</b> React.js, Redux, Modern JavaScript (ES6+)
                                </div></li>
                                <li class="course-acc-li"><div><b>Backend Development:</b> Node.js, Nest.js, Express.js</div></li>
                                <li class="course-acc-li"><div><b>Database Management:</b> MongoDB, PostgreSQL</div></li>
                                <li class="course-acc-li"><div><b>Cloud Infrastructure:</b> AWS
                                </div></li>
                                <li class="course-acc-li"><div><b>Blockchain Integration:</b> Smart Contract Development</div></li>
                                <li class="course-acc-li"><div><b>DevOps:</b> Git, CI/CD, Testing (Jest, Mocha, Cypress)</div></li>
                            </ul>
                        </div>
                        ...
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>Master's in Computer Science (MSCIT)</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>Bachelor's in Computer Applications (BCA)</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>C Language Certification</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>Successfully led multiple blockchain-integrated web applications.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>Implemented performance optimizations resulting in significant load time improvements.</div></li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div>Established robust security protocols for authentication and payment systems.</div></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
