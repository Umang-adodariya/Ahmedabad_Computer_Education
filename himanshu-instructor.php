    ...
    <section class="space">
        <div class="container">
                ...
                <div class="row gx-40">
                    <div class="col-lg-6 position-relative">
                        <div class="team-details-thumb">
                            <img src="assets/img/instructor/instructorDetail/himanshu-dabhi.jpg" alt="team image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-box">
                            <div class="about-info">
                                <h2 class="title">Himanshu Dabhi</h2>
                                <p class="desig">MERN Stack Developer</p>
                            </div>
                        ...
                        <p>Himanshu Dabhi is a skilled MERN stack developer with a passion for building robust and scalable web applications. With over 2+ years of experience, Himanshu has honed his skills in HTML, CSS, Tailwind, JavaScript, MongoDB, PostgreSQL, SwaggerUI, Express.js, React.js, Nestjs, and Node.js.</p>
                        <div class="about-quality">
                            <div class="quality-box">
                                <span class="quality-text">Course: 1</span>
                                <span class="quality-text">Students: 300+</span>
                            </div>
                            <div class="quality-box">
                            ...
                            <div class="quality-box">
                                ...
                                <span class="quality-text">2 Years</span>
                            </div>
                        </div>
            ...
            <div class="space-top">
                <div class="row">
                    <div class="col-lg-8">
                        <p>With 2+ years of teaching experience, Himanshu is adept at breaking down complex concepts into easy-to-understand explanations. He is committed to fostering a collaborative learning environment where students can experiment, learn, and grow.
                        </p>
                        <h3 class="title h4 fw-semibold mb-40">Areas of Expertise:</h3>
                        <div class="checklist mb-40">
                            <ul class="course-acc-ul">
                                <li class="course-acc-li"><div><b>MERN Stack Development:</b> Design, develop, and deploy full-stack web applications.</div></li>
                                <li class="course-acc-li"><div><b>Web Design:</b> Create visually appealing and user-friendly websites.
                                </div></li>
                                <li class="course-acc-li"><div><b>Web Application Architecture:</b> Design efficient and scalable application architectures.</div></li>
                                <li class="course-acc-li"><div><b>Teaching & Leadership:</b> Mentor and guide aspiring developers.</div></li>
                            </ul>
                        </div>
                        ...
                        <div class="checklist style5 mt-30">
                            <ul>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i>Bachelor's in Information Technology (B.E. IT)</li>
                                <li><i class="fa-solid fa-file-certificate text-theme me-2"></i><div><b>Real-world Experience:</b> Learn from a seasoned developer with hands-on experience.
                                </div></li>
