    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-course-detail.png" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title">AI / ML Training & Certification Course</h1>
                    ...
                    <div class="course-single">
                        <div class="course-single-top">
                            <div class="course-img">
                                <img src="assets/img/courses/corses-main/ali-1.jpg" alt="Course Image">
                            ...
                            <h2 class="course-title">AI / ML Training Course</h2>
                        </div>
                            ...
                            <div class="tab-content" id="productTabContent">
                                <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                    <div class="course-description">
                                        ...
                                        <p>The simplest way to understand how AI and ML relate to each other is: AI is the broader concept of enabling a machine or system to sense, reason, act, or adapt like a human. ML is an application of AI that allows machines to extract knowledge from data and learn from it autonomously.</p>
                                ...
                                <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                    <div class="course-curriculam">
                                        <h5 class="h5">Course Program Duration and Curriculum</h5>
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">INTRODUCTION TO PYTHON</li>
                                                                    <li class="course-acc-li">INTRODUCTION TO MACHINE LEARNING</li>
                                                                    <li class="course-acc-li">INTRODUCTION TO NEURAL NETWORKS</li>
                                                                    <li class="course-acc-li">PROGRAMMING STYLE</li>
                                                                    <li class="course-acc-li">CONDITIONAL STATEMENTS</li>
                                                                    <li class="course-acc-li">LOOPS</li>
                                                                    <li class="course-acc-li">CONTROLS</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseTwo" class="accordion-collapse course-acc-collapse collapse" aria-labelledby="headingTwo"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">IMPORTING LIBRARIES AND DATABASES</li>
                                                                    <li class="course-acc-li">INTRODUCTION TO NUMPY</li>
                                                                    <li class="course-acc-li">CREATING AND INDEXING ARRAYS</li>
                                                                    <li class="course-acc-li">ARRAY SLICING</li>
                                                                    <li class="course-acc-li">ARRAY SHAPE</li>
                                                                    <li class="course-acc-li">ARRAY ITERATING</li>
                                                                    <li class="course-acc-li">NUMPY RANDOM</li>
                                                                    <li class="course-acc-li">DATA DISTRIBUTION</li>
                                                                    <li class="course-acc-li">NUMPY UFUNC</li>
                                                                    <li class="course-acc-li">INTRODUCTION TO PANDAS</li>
                                                                    <li class="course-acc-li">PANDAS SERIES</li>
                                                                    <li class="course-acc-li">PANDAS DATAFRAMES</li>
                                                                    <li class="course-acc-li">PANDAS READ CSV, JSON</li>
                                                                    <li class="course-acc-li">PANDAS ANALYSING DATA</li>
                                                                    <li class="course-acc-li">CLEANING DATA</li>
                                                                    <li class="course-acc-li">PANDAS PLOTTING</li>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingThree">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            MODULE 3 [ MATPLOTLIB & SCIKIT INTRODUCTION ]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseThree" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">INTRODUCTION TO MATPLOTLIB</li>
                                                                    <li class="course-acc-li">PLOTTINGS</li>
                                                                    <li class="course-acc-li">VISUALISING</li>
                                                                    <li class="course-acc-li">INTRODUCTION TO SCIKIT LEARN</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseFour" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">TRAINING</li>
                                                                    <li class="course-acc-li">TESTING</li>
                                                                    <li class="course-acc-li">VALIDATION</li>
                                                                    <li class="course-acc-li">TIME FORECASTING</li>
                                                                    <li class="course-acc-li">INTRODUCTION TO MACHINE LEARNING</li>
                                                                    <li class="course-acc-li">REGRESSION</li>
                                                                    <li class="course-acc-li">CLASSIFICATION</li>
                                                                    <li class="course-acc-li">SUPERVISED AND UNSUPERVISED</li>
                                                                    <li class="course-acc-li">LEARNING LINEAR REGRESSION</li>
                                                                    <li class="course-acc-li">DATA REGULARIZATION</li>
                                                                    <li class="course-acc-li">MODELLING OF TIME SERIES</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    <h2 class="accordion-header" id="headingFive">
                                                        <button class="accordion-button course-acc-button collapsed" type="button" data-bs-toggle="collapse"
                                                            ...
                                                            MODULE 5 [ TENSORFLOW INTRODUCTION ]
                                                        </button>
                                                    </h2>
                                                    <div id="collapseFive" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">INTRODUCTION TO TENSORFLOW TF OPERATIONS</li>
                                                                    <li class="course-acc-li">TENSORS OPERATIONS</li>
                                                                    <li class="course-acc-li">CREATING A MODEL</li>
                                                                    <li class="course-acc-li">ADDING LAYERS TO THE MODEL</li>
                                                                    <li class="course-acc-li">COMPILING THE MODEL</li>
                                                                    <li class="course-acc-li">TRAINING THE MODEL</li>
                                                                    <li class="course-acc-li">USING THE MODEL BAR GRAPHS</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseSix" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">INTRODUCTION TO PYTORCH TORCH TO</li>
                                                                    <li class="course-acc-li">NUMPY BRIDGE NUMPY TO</li>
                                                                    <li class="course-acc-li">TORCH BRIDGE GPU AND CPU TOGGLING</li>
                                                                    <li class="course-acc-li">LINEAR REGRESSION WITH PYTORCH</li>
                                                                    <li class="course-acc-li">LOGISTIC REGRESSION WITH PYTORCH CNN WITH PYTORCH</li>
                                                                    </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-item course-acc-item">
                                                    ...
                                                    <div id="collapseSix" class="accordion-collapse course-acc-collapse collapse"
                                                        ...
                                                        <div class="accordion-body course-acc-body">
                                                            <div class="checklist mb-1">
                                                                <ul class="course-acc-ul">
                                                                    <li class="course-acc-li">INTRODUCTION TO RCNN</li>
                                                                    <li class="course-acc-li">MODELS IN RCNN LSTM</li>
                                                                    <li class="course-acc-li">LANGUAGE MODELS NLP</li>
                                                                    <li class="course-acc-li">SPACY</li>
                                                                    </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info  ">
                            <div class="th-video">
                                <img src="assets/img/courses/corses-main/ai-2.jpg" alt="video">
